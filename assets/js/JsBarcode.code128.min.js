...
!(function (t) {
  ...
  function (t, e, n) {
    ...
    (e.MODULO = 103),
      (e.STOP = 106),
      (e.FNC1 = 207),
      (e.SET_BY_CODE = (o((r = {}), s, i), o(r, f, a), o(r, c, u), r)),
    ...
    (e.getMaximumHeightOfEncodings = function (t) {
      ...
      (e.calculateEncodingAttributes = function (t, e, n) {
        for (var r = 0; r < t.length; r++) {
          var o,
            f = t[r],
            c = (0, i.default)(e, f.options);
          o = c.displayValue ? s(f.text, c, n) : 0;
          var l = f.data.length * c.width;
          (f.width = Math.ceil(Math.max(o, l))),
            (f.height = a(f, c)),
            (f.barcodePadding = u(o, l, c));
        }
      }),
    ...
    var p = function () {},
      h = function (t, e, n) {
        ...
        return (
          ...
          (r._errorHandler = new f.default(r)),
          void 0 !== e &&
            ((n = n || {}).format || (n.format = b()),
            r.options(n)[n.format](e, n).render()),
          r
        );
      };
    for (var v in ((h.getModule = function (t) {
      return r.default[t];
    }),
    r.default))
      r.default.hasOwnProperty(v) && g(r.default, v);
    function g(t, e) {
      p.prototype[e] =
      ...
      (p.prototype.render = function () {
        ...
        if (Array.isArray(this._renderProperties))
          for (var t = 0; t < this._renderProperties.length; t++)
            _(this._renderProperties[t], this._encodings, this._options);
        else _(this._renderProperties, this._encodings, this._options);
        return this;
      }),
      (p.prototype._defaults = l.default),
  ...
  function (t, e, n) {
    ...
    function u(t, e) {
      ...
      if (o)
        return o[1] + String.fromCharCode(204) + s(t.substring(o[1].length));
          ...
          o(t, [
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var r,
                  o,
                  i = this.document.createElementNS(s, "text");
                e.displayValue &&
                  (i.setAttribute(
                    "style",
